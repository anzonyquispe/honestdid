...
# Delta_SD | Mvec = [0, 0.01, ..., 0.10] -> 11 values
# Data: Medicaid expansion (same as HonestDiD R README)
# ============================================================
...
# --- 1. Load betahat and sigma from R -------------------
...
print(f"  Mvec           = {[round(m,2) for m in Mvec]}  ({len(Mvec)} values)\n")

# --- 2. Benchmark ---------------------------------------
print("Running hd.createSensitivityResults (Delta_SD)...\n")
...
# --- 3. Results -----------------------------------------
print("--- Delta_SD Results ---")
print(delta_sd_results)
print(f"\n  Execution time (Python/{device.upper()}): {elapsed:.4f} seconds")
print("=" * 55)
