...
foldername = '/Users/anzony.quisperojas/Documents/GitHub/py_did_multiplegt_stat/honest_test_V'
betahat = pd.read_csv(f"{foldername}/betahat.csv")["betahat"].values
sigma   = pd.read_csv(f"{foldername}/sigma.csv").values
